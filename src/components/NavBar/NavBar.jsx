        ...
        <div className="navbar bg-[#d9d9d9]">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="text-black dropdown-content mt-3 z-[1] p-2 shadow font-semibold rounded-box w-52">
                        {router}
                    </ul>
                </div>
                <Link to="/" className="text-sky-600 font-display font-bold text-4xl">College Quest Hub</Link>
            </div>
