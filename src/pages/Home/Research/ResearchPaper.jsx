            ...
            <div>
                ...
                <div className='w-4/5 mx-auto gap-5 flex flex-col lg:flex-row mt-5 mb-20'>
                    <div className='w-1/2 mx-auto'>
                        <li>Google Scholar <Link className="font-semibold text-sky-500" to="www.scholar.google.com">(scholar.google.com):</Link> This is a freely accessible search engine that indexes the full text or metadata of scholarly literature across various disciplines and sources.</li>

                        <li>PubMed <Link className="font-semibold text-sky-500" to="www.ncbi.nlm.nih.gov/pubmed/">(www.ncbi.nlm.nih.gov/pubmed/):</Link> A free database that primarily focuses on life sciences and biomedical topics, providing access to a vast collection of research articles.</li>
